...
var menu = {
  html: '<div class="modal"><div class="links"><ul><a href="/main"><li>My Inshallah Profile / صفحتي الشخصية</li></a><a href="#search"><li>Search / بحث</li></a><a href="#about"><li class="about">About Inshallah</li></a><a href="https://docs.google.com/forms/d/16EC6IcvYIWvaEvRRHBZYlpaMbo6eLCl4Dud3miyoZE0/viewform"><li>Contact Inshallah / اتصل بنا</li></a><a onclick="logout()"><li class="logout">Log Out</li></a></ul></div></div>',
  visible: false,
};
